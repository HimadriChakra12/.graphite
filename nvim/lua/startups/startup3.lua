local function show_dashboard()
  -- Only show if no file was specified and we're not reopening a session
  if vim.fn.argc() == 0 and vim.fn.line2byte('$') == -1 then
    ...
    vim.api.nvim_win_set_cursor(0, {17, 6})
...
-- Show dashboard on VimEnter if no file was specified
vim.api.nvim_create_autocmd("VimEnter", {
  callback = show_dashboard,
  nested = true
})

-- Alternative: Create command to manually show dashboard
